...
for fold in range(5):
    ...
    text_field.build_vocab(train, min_freq=2, vectors="fasttext.en.300d")
    ...
    embedding_dim = 300
    model = GRU_Model(bert, hidden_size, dropout)
    print("###################################")
    ...
    best_model = GRU_Model(bert, hidden_size, dropout).to(device)
